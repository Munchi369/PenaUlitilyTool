...
[Releases](https://github.com/Munchi369/PenaUlitilyTool/releases) から、最新の `PenaUtilityToolzip.zip` をダウンロードしてください。
...
ペナントシミュレーション３ver3.4.11にしか対応していません。
...
| 機能         | 内容                          |
| ---------- | --------------------------- |
| 能力一括調整     | 条件を指定して、選手能力をまとめて増減できます     |
| 選手検索・詳細    | 選手能力、成績、名鑑用データなどを確認・出力できます  |
| 成績CSV出力    | 指定年度の成績をCSV形式で出力できます        |
| コメントあり選手一覧 | コメントが登録されている選手だけを一覧表示できます   |
| 装備設定       | 選手に装備を設定し、能力変化を楽しめます        |
| 装備一覧       | 装備名、レア度、所持数、効果、装備者を確認できます   |
| 装備ガチャ      | 所持金を使って装備ガチャを回せます           |
| 再建モード      | 借金状態や能力低下を使った縛りプレイができます     |
| 監督ビルダー     | オリジナル監督を作成し、候補一覧やチームに反映できます |
| SOUGOU再計算  | 本体準拠の計算式で総合値を再計算できます        |
| ブックメーカー    | ペナント結果に対する予想・賭け・払戻を管理できます   |
| 収支グラフ      | ブックメーカーの利益・損失を年度別に確認できます    |
| 装備メンテナンス   | 装備関連の復旧・初期化・再構築ができます        |
