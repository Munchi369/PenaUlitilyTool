...
作成された `.json` ファイルは、ツールの新規選手作成画面からインポートし、内容を確認してから登録できます。
...
選手ID、背番号自動採番、総合値など、ツール側で決まる項目は作成時に再計算・確認されます。

### Gemini Gem との連携

新規選手作成用のGemで作成した `.json` ファイルをインポートできます。

AIに選手像をチャットで伝え、作成されたJSONを読み込むことで、架空選手やロールプレイ用選手を作りやすくなります。
