...
* [打順自動編成](#13-打順自動編成)
* [監督ビルダー](#14-監督ビルダー)
* [SOUGOU再計算](#15-sougou再計算)
* [ブックメーカー](#16-ブックメーカー)
* [収支グラフ](#17-収支グラフ)
* [データベースメンテナンス](#18-データベースメンテナンス)
...
通常は、上記の [装備管理](#10-装備管理) 画面から追加・編集してください。
